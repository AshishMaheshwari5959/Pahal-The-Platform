			...
			<div class="row justify-content-center d-flex">
				<div class="col-lg-8 post-list">
					...
					<div class="single-post d-flex flex-row">
						<div class="thumb">
							<img src="assets/img/about-boxes-2.jpg" alt="">
							<div class="vacancy">20 Vacancies</div>
						</div>
						<div class="details">
							<div class="title d-flex flex-row justify-content-between">
								<div class="titles">
									...
									<h6>eArth Samvarta Foundation, Ayodhya, Uttar Pradesh</h6>
								</div>
								<ul class="btns">
							...
							<p>Requirement of a competent & hard-working candidate for management of environment
							campaigns.
							</p>
							<div class="bottom-info" style="display: flex; justify-content: space-between;">
								
								<h5 class="job-type">Full time</h5>
