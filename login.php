...
<div class="container" id="container">
    <div class="form-container sign-up-container">
        ...
        <form method="POST">
            ...
            <input type="email" name="org_username" placeholder="Username or Email" required />
            <input type="password" name="org_password" placeholder="Password" required />
            <a class="zoom" href="#">Forgot your password?</a>
            <span><button type="submit" name="org_login" style="text-decoration:none; color: white;">Login</button></span>
            <p>Haven't registered yet?<a href="org_signup.php" style="color: #ff4a17; font-weight: 600; font-size: 12px;"> Sign up now!</a></p>
        </form>
    </div>
    <div class="form-container sign-in-container">
        <form method="POST">
            ...
            <p>Haven't registered yet?<a href="user_signup.php" style="color: #ff4a17; font-weight: 600; font-size: 12px;"> Sign up now!</a></p>
        </form>
    </div>
